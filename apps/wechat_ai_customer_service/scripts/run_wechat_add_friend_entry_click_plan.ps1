...
Write-Host "Running add_friend entry click plan. It opens the add-friend entry, searches the contact, clicks add-contact, fills invite text and remark, clicks confirm, then writes the review report."
