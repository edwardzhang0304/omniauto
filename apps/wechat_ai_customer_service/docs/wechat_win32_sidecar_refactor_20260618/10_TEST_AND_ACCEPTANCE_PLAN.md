...
## 阶段测试记录 2026-06-19 Phase 3.5g

stage: Phase 3.5g window action state helper

files changed:

- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr_sidecar.py`
- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr/window_action_state.py`
...
- artifact scopes changed: no
- facade callable names changed: no
- focus/foreground execution moved: no

tests:

- `.\.venv\Scripts\python.exe -m py_compile apps\wechat_ai_customer_service\adapters\wechat_win32_ocr_sidecar.py apps\wechat_ai_customer_service\adapters\wechat_win32_ocr\window_action_state.py apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_window_action_state_checks.py` -> passed.
...
- not run; this stage only moved pure focus/tray-hidden state predicates.

rollback:

- restore inline ready-reason set checks in sidecar and leave `window_action_state.py` unused for review.

## 阶段测试记录 2026-06-19 Phase 3.5h

stage: Phase 3.5h activate_window fake execution coverage
...
- `.\.venv\Scripts\python.exe -m py_compile apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_window_activation_checks.py` -> passed.
...
- not run; fake execution tests intentionally avoid touching real WeChat focus, keyboard, and mouse.
...
## 阶段测试记录 2026-06-19 Phase 3.5j

stage: Phase 3.5j activate_window settings/debounce helper
...
- not run; this stage moved only activation settings/debounce predicates.

rollback:

- restore inline aggressive/attach/debounce calculation in `activate_window`; keep helper functions unused for review.

## 阶段测试记录 2026-06-19 Phase 3.5k

stage: Phase 3.5k visible window selection planning helper

files changed:

- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr_sidecar.py`
- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr/window_action_planning.py`
- `apps/wechat_ai_customer_service/tests/run_wechat_win32_ocr_window_selection_planning_checks.py`
- `apps/wechat_ai_customer_service/docs/wechat_win32_sidecar_refactor_20260618/07_PHASE_3_DEVICE_LAYOUT_CAPTURE_GUIDE.md`
- `apps/wechat_ai_customer_service/docs/wechat_win32_sidecar_refactor_20260618/10_TEST_AND_ACCEPTANCE_PLAN.md`
...
- artifact scopes changed: no
- facade callable names changed: no
- capture/OCR execution moved: no
- focus/foreground execution moved: no

tests:

- `.\.venv\Scripts\python.exe -m py_compile apps\wechat_ai_customer_service\adapters\wechat_win32_ocr_sidecar.py apps\wechat_ai_customer_service\adapters\wechat_win32_ocr\window_action_planning.py apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_window_selection_planning_checks.py` -> passed.
...
- not run; this stage only moved candidate scoring/selection planning.

rollback:

- restore inline score tuple selection in `select_primary_visible_main_window`; keep selection helpers unused for review.

## 阶段测试记录 2026-06-19 Phase 3.5l

stage: Phase 3.5l window content health score signal helper
...
- `.\.venv\Scripts\python.exe -m py_compile apps\wechat_ai_customer_service\adapters\wechat_win32_ocr_sidecar.py apps\wechat_ai_customer_service\adapters\wechat_win32_ocr\render_diagnostics.py apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_render_diagnostics_checks.py` -> passed.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_render_diagnostics_checks.py` -> passed, 6 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_compat_checks.py` -> passed, 135 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_window_selection_planning_checks.py` -> passed, 4 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_ensure_visible_planning_checks.py` -> passed, 6 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_add_friend_package_smoke.py` -> passed, 34 checks.
...
- not run; this stage moved only pure scoring after fake capture/OCR signal preparation.
...
## 阶段测试记录 2026-06-19 Phase 3.5n

stage: Phase 3.5n ensure_visible window visibility orchestration helper

files changed:

- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr_sidecar.py`
- `apps/wechat_ai_customer_service/adapters/wechat_win32_ocr/window_visibility.py`
- `apps/wechat_ai_customer_service/tests/run_wechat_win32_ocr_ensure_visible_planning_checks.py`
- `apps/wechat_ai_customer_service/docs/wechat_win32_sidecar_refactor_20260618/07_PHASE_3_DEVICE_LAYOUT_CAPTURE_GUIDE.md`
- `apps/wechat_ai_customer_service/docs/wechat_win32_sidecar_refactor_20260618/10_TEST_AND_ACCEPTANCE_PLAN.md`
...
- artifact scopes changed: no
- facade callable names changed: no
- `ensure_visible_wechat_window(interactive=...)` old entry removed: no
- add-friend entry command changed: no

tests:

- `.\.venv\Scripts\python.exe -m py_compile apps\wechat_ai_customer_service\adapters\wechat_win32_ocr_sidecar.py apps\wechat_ai_customer_service\adapters\wechat_win32_ocr\window_visibility.py apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_ensure_visible_planning_checks.py` -> passed.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_ensure_visible_planning_checks.py` -> passed, 6 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_wechat_win32_ocr_compat_checks.py` -> passed, 135 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_add_friend_package_smoke.py` -> passed, 34 checks.
- `.\.venv\Scripts\python.exe apps\wechat_ai_customer_service\tests\run_customer_service_multi_session_scheduler_checks.py` -> passed, 123 checks.
...
- not run; this stage moved visibility orchestration into a dependency-injected helper and kept real actions in injected sidecar functions.

rollback:

- move `ensure_visible_wechat_window_with_dependencies` body back into sidecar `ensure_visible_wechat_window`; keep `window_visibility.py` unused for review.
